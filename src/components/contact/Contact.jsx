...
const Contact = () => {
  return (
    <motion.section className=" min-h-screen bg-gray-900 text-white"
    initial="hidden"
        whileInView="show"
        ...
        <div className="flex flex-col my-20">
          <div className="mx-auto border-2 border-gray-500 w-full max-w-5xl bg-gray-800 rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <motion.div className="w-full md:w-1/3 p-6 bg-gradient-to-r from-gray-900 to-gray-800 text-white"
